...
func ExampleSerializer_Marshal_Tree() {
  ...
  if len(blob.Tree.Entries) >= 2 {
    fmt.Println(blob.Tree.Entries[0].Name)
    fmt.Println(hex.EncodeToString(blob.Tree.Entries[1].Hash))
  }
  // Output:
  // 2
  // bob
  // e673cec71f4dbbe6e765f3f448f705a4c78d157f
}
